...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 13:22:14 2019
...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 11:38:14 2019
...
df=data[['Area','Price_Sqft','YearBuilt','WalkScore','TransitScore','Bedroom','Bathroom','ZipCode','Price']]
...
df=df.astype(int)
df=df[['Area','Price_Sqft','YearBuilt','WalkScore','TransitScore','Bedroom','Bathroom','ZipCode','cluster','Price']]
