...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 17:02:37 2019
...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 16:13:56 2019
...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 15:51:41 2019
...
df=data[['Area','Bedroom','Bathroom','WalkScore','TransitScore','Parking','zip','Price']]
...
df=df.astype(int)
df=df[['Area','Bedroom','Bathroom','TransitScore','WalkScore','Parking','zip','cluster','Price']]
...
print('score for random_forest:',random_forest.score(X_train,y_train))
