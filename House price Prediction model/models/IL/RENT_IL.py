...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 20 10:27:07 2019
...
data=data.replace('249 spaces','24')
data=data.replace('--',np.nan)
data=data.replace('35 spaces','3')
data=data.replace('56 spaces','5')
data=data.replace('219 spaces','21')
data=data.replace('42 spaces','3')
