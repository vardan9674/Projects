...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 18 12:16:30 2019
...
data= pd.read_csv('Md_Rent_townHouse.csv')


data = data.rename(columns = {"Bedrooms":"Bedroom","Bathrooms":"Bathroom","AreaSpace_SQFT":"Area","Parking:":"Parking","Price":"Rent","ZipCode":"zip"}) 
...
data['Bathroom']=data.Bathroom.astype(str).str.replace('27.5','7.5')
data['Bathroom']=data.Bathroom.astype(str).str.replace('1.5','1')
