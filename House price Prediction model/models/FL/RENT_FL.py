...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 20 10:11:34 2019
...
data=data.replace('Carport, On street, Attached Garage','1')
data=data.replace('191 spaces','3')
data=data.replace('Carport, On street, Attached Garage','1')
data=data.replace('1400 spaces','14')
data=data.replace('79 spaces','7')
data=data.replace('225 spaces','2')
data=data.replace('26 spaces','2')
data=data.replace('85 spaces','8')
data=data.replace('Garage','1')
data=data.replace('Carport, Off street, On street, Attached Garage, Detached Garage','1')
data=data.replace('250 spaces','2')
data=data.replace('Carport, On street, Attached Garage, Detached Garage','1')
data=data.replace('Carport, Off street, On street, Attached Garage','1')
data=data.replace('Garage, Open','1')
data=data.replace('87 spaces','1')
