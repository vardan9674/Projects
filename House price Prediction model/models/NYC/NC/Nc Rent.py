...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 14:47:23 2019
...
data['Bathroom']=data.Bathroom.astype(str).str.replace('25.0','2.5')
data['Bathroom']=data.Bathroom.astype(str).str.replace('27.5','7.5')
data['Bathroom']=data.Bathroom.astype(str).str.replace('25','2.5')
data['Bathroom']=data.Bathroom.astype(str).str.replace('35','3.5')
...
data=data.replace('43 spaces','4')
data=data.replace('42 spaces','4')
data=data.replace('58 spaces','5')
data=data.replace('45 spaces','4')
data=data.replace('30 spaces','3')
...
df=data[['Area','YearBuilt','Bedroom','Bathroom','Parking','ZipCode','Price']]
...
df['Bathroom']=df.Bathroom.astype(str).str.replace('35','3.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('25','2.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('45','4.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('55','5.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('15','1.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('175','1.75')
df['Bathroom']=df.Bathroom.astype(str).str.replace('55','5.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('275','2.75')
df['Bathroom']=df.Bathroom.astype(str).str.replace('525','5.25')
df['Bathroom']=df.Bathroom.astype(str).str.replace('65','6.5')
df['Bathroom']=df.Bathroom.astype(str).str.replace('52.5','5.25')
...
df=df[['Area','YearBuilt','Bedroom','Bathroom','Parking','ZipCode','Price']]
