...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 14 14:22:09 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 14 14:08:42 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 14 12:14:58 2019
...
data['Price_PerSQFT'] = data.Price_PerSQFT.replace('Contact manager',np.nan)
...
data['Price_PerSQFT']=data.Price_PerSQFT.replace('No Data',np.nan)
...
data['Price_PerSQFT']=data.Price_PerSQFT.astype(float)

data['Price_PerSQFT'].value_counts()

df=data[['Area','Price_PerSQFT','YearBuilt','WalkScore','TransitScore','Bedroom','Bathroom','ZipCode','Price']]
...
df=df.astype(int)
df=df[['Area','Price_PerSQFT','YearBuilt','WalkScore','TransitScore','Bedroom','Bathroom','ZipCode','cluster','Price']]
